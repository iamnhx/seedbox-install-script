...
function Deluge_install {
    ...
    if [[ $distro_codename = buster ]]; then
        ...
        wget https://raw.githubusercontent.com/iamnhx/seedbox-install-script/main/Torrent%20Clients/Deluge/libtorrent/buster_libtorrent-rasterbar_$libtorrent_Ver-amd64.deb
...
EOF
        ...
        wget https://raw.githubusercontent.com/iamnhx/seedbox-install-script/main/Torrent%20Clients/Deluge/boost/boost-1-69-0_20220512-1_amd64.deb
        dpkg -i boost-1-69-0_20220512-1_amd64.deb
        wget https://raw.githubusercontent.com/iamnhx/seedbox-install-script/main/Torrent%20Clients/Deluge/libtorrent/bullseye_libtorrent-rasterbar_$libtorrent_Ver-amd64.deb
        dpkg -r libtorrent-rasterbar
...
EOF
    ...
    mkdir -p /home/$username/downloads /home/$username/downloads/incomplete /home/$username/watch && chown -R $username /home/$username
    ...
    cat << EOF >/home/$username/.config/deluge/core.conf
{
  ...
  "download_location": "/home/$username/downloads/incomplete", 
  ...
  "torrentfiles_location": "/home/$username/watch, 
  ...
  "autoadd_location": "/home/$username/watch/", 
...
EOF
    ...
    wget https://raw.githubusercontent.com/iamnhx/seedbox-install-script/main/Torrent%20Clients/Deluge/deluge.Userpass.py
    wget https://raw.githubusercontent.com/iamnhx/seedbox-install-script/main/Torrent%20Clients/Deluge/deluge.addHost.py
