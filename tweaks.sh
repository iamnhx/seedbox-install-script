...
function Network_Other_Tweaks {
    normal_1; echo "Doing other Network Tweaks"; warn_2
    #Other 1
...
## File Open Limit
function file_open_limit_Tweaks {
...
function Tweaked_BBR {
    ...
    wget https://raw.githubusercontent.com/iamnhx/seedbox-install-script/main/Miscellaneous/BBR/BBR.sh && chmod +x BBR.sh
