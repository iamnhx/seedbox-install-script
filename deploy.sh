...
password=$2
cache=$3
randomPort=$(shuf -i 20000-65000 -n 1)
...
source <(wget -qO- https://raw.githubusercontent.com/iamnhx/seedbox-install-script/main/seedbox_installation.sh)
Update
