## Usage
### deploy.sh
`bash <(wget -qO- https://raw.githubusercontent.com/iamnhx/seedbox-install-script/main/deploy.sh) <username> <password> <Cache Size(unit:GiB)>`

### tune.sh if you have already installed clients (Likely to break something, becareful)

`bash <(wget -qO- https://raw.githubusercontent.com/iamnhx/seedbox-install-script/main/tune.sh)`
